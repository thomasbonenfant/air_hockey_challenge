...
class Core(object):
    ...
    def __init__(self, agent, mdp, callbacks_fit=None, callback_step=None):
        ...
        self.vel_max = self.mdp.env_info['constraints'].get('joint_vel_constr').joint_limits[1]
        self.pos_max = self.mdp.env_info['constraints'].get('joint_pos_constr').joint_limits[1]
    ...
    def _run_impl(self, move_condition, fit_condition, steps_progress_bar,
        ...
        while move_condition():
            ...
            flag = np.random.uniform() < self.percentage
            ...
            if flag:
                ...
                s, s_info = self.random_step(render, action)
            if fit_condition():
    ...
    def random_step(self, render, action):
