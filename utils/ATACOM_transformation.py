...
from examples.rl.atacom import ConstraintList
from examples.rl.atacom.system import AccelerationControlSystem, VelocityControlSystem
from utils.ATACOM_utils.ATACOM_controller import ATACOMController
from utils.ATACOM_utils.constraints_ATACOM import EndEffectorConstraint

# from envs.air_hockey_challenge.

class AtacomTransformation(AgentBase):

    def __init__(self, env_info, double_integration, atacom_controller: ATACOMController):
    ...
    def draw_action(self, state, action):
        """
        Args:
